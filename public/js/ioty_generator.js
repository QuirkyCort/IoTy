var ioty_generator = new function() {
  ...
  this.generators = {
    ...
    'digital_read_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'digital_write_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'analog_read_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'set_analog_write_freq': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'analog_write_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'servo_write_deg': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_set_pin_mode': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_set_pin_hold': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_digital_read_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_digital_write_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_analog_read_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_touch_read_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_set_analog_write_freq': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_analog_write_pin': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_servo_write_deg': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_servo_write_us': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'adv_hc_sr04_ping': function(block) {
      self.iotyImports['pin'] = 'pin';
    ...
    'wait_until_connected': function(block) {
    ...
    'bytearray_by_size': function(block) {
    ...
    'connect_to_wifi': function(block) {
    ...
    'connect_to_wifi_blocks_input': function(block) {
      self.imports['ioty_wifi'] = 'import ioty.wifi';
      self.reservedVariables['connect_to_wifi'] = ['ioty_wifi'];
    ...
    'connect_to_configured_wifi': function(block) {
      self.imports['ioty_wifi'] = 'import ioty.wifi';
      self.reservedVariables['connect_to_wifi'] = ['ioty_wifi'];
    ...
    'wlan_get_ip': function(block) {
      var code = 'ioty.wifi.get_ip()';

      return [code, Blockly.Python.ORDER_NONE];
    },

    'start_as_ap': function(block) {
      self.imports['ioty_wifi'] = 'import ioty.wifi';
    ...
    'wlan_is_present': function(block) {
      self.imports['ioty_wifi'] = 'import ioty.wifi';
    ...
    'wlan_is_connected': function(block) {
      self.imports['ioty_wifi'] = 'import ioty.wifi';
    ...
    'setBluetoothCmds': function(block) {
    ...
    'run_python_and_return': function(block) {
      let value = block.getFieldValue('value');
    ...
    'mqtt_connect_to_server': function(block) {
    ...
    'mqtt_wait_msg': function(block) {
      var code = 'ioty_mqtt.wait_msg()\n';

      return code;
    },

    'mqtt_check_msg': function(block) {
      var code = 'ioty_mqtt.check_msg()\n';

      return code;
    },

    'mqtt_on_receive': function(block) {
      // First, add a 'global' statement for every variable that is not shadowed by
      // a local parameter.
      const globals = [];
      const workspace = blockly.workspace;
    ...
    'mqtt_publish_bytes': function(block) {
      var topic = block.getFieldValue('topic');
      var value = Blockly.Python.valueToCode(block, 'value', Blockly.Python.ORDER_NONE);
    ...
    'i2c_init_with_pins': function(block) {
      self.imports['machine'] = 'import machine';
    ...
    'i2c_writeto_mem': function(block) {
      self.imports['struct'] = 'import struct';
    ...
    'i2c_readfrom_mem': function(block) {
      self.imports['struct'] = 'import struct';
    ...
    'i2c_readfrom_bytes': function(block) {
      var id = block.getFieldValue('id');
      var address = Blockly.Python.valueToCode(block, 'address', Blockly.Python.ORDER_NONE);
    ...
    'date_time_set_ntp': function(block) {
    ...
    'esp32_temperature': function(block) {
    ...
    'mpu6050_calibrate': function(block) {
      var code = 'mpu6050_device.calibrate_gyro()\n';

      return code;
    },

    'mpu6050_reset': function(block) {
    ...
    'mpu6050_update': function(block) {
      var code = 'mpu6050_device.update_angle()\n';

      return code;
    },

    'mpu6050_accel': function(block) {
    ...
    'mpu6050_temperature': function(block) {
    ...
    'mpu6050_get_calibration': function(block) {
      var code = 'mpu6050_device.get_calibration()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'mpu6050_set_calibration': function(block) {
    ...
    'pca9685_set_freq': function(block) {
      var freq = block.getFieldValue('freq');
    ...
    'pca9685_analog_write': function(block) {
    ...
    'pca9685_write_angle': function(block) {
      var channel = Blockly.Python.valueToCode(block, 'channel', Blockly.Python.ORDER_ATOMIC);
      var value = Blockly.Python.valueToCode(block, 'value', Blockly.Python.ORDER_ATOMIC);
    ...
    'pca9685_write_us': function(block) {
      var channel = Blockly.Python.valueToCode(block, 'channel', Blockly.Python.ORDER_ATOMIC);
      var value = Blockly.Python.valueToCode(block, 'value', Blockly.Python.ORDER_ATOMIC);
    ...
    'ssd1306_init_sh1106': function(block) {
      self.imports['ssd1306'] = 'import ssd1306';
      self.reservedVariables['ssd1306_init'] = ['ssd1306_i2c'];
    ...
    'ssd1306_show': function(block) {
      var code = 'ssd1306_i2c.show()\n';

      return code;
    },

    'ssd1306_text': function(block) {
    ...
    'ssd1306_ellipse': function(block) {
      var x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_ATOMIC);
      var y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_ATOMIC);
    ...
    'dict_key_value_input': function(block) {
    ...
    'urequests_advance': function(block) {
      self.imports['urequests'] = 'import urequests';
      self.reservedVariables['urequests_advance'] = ['urequest'];
    ...
    'urequests_simple': function(block) {
      return self.generators['urequests_advance'](block);
    },

    'urequests_connect': function(block) {
      self.imports['urequests'] = 'import urequests';
    ...
    'urequests_settimeout': function(block) {
    ...
    'esp_now_add_peer': function(block) {
      self.imports['binascii'] = 'import binascii';
    ...
    'esp_now_remove_peer': function(block) {
      self.imports['binascii'] = 'import binascii';
    ...
    'esp_now_get_msg': function(block) {
    ...
    'esp_now_msg_available': function(block) {
      let code = 'esp_now.any()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'ez_esp_now_init': function(block) {
    ...
    'ez_esp_now_set_group': function(block) {
    ...
    'ez_esp_now_send': function(block) {
      let value = Blockly.Python.valueToCode(block, 'value', Blockly.Python.ORDER_ATOMIC);
    ...
    'ez_esp_now_get_msg': function(block) {
    ...
    'ez_httpd_available': function(block) {
    ...
    'ez_httpd_send_response': function(block) {
    ...
    'ez_httpd_send_bytes': function(block) {
      let response = Blockly.Python.valueToCode(block, 'response', Blockly.Python.ORDER_ATOMIC);
    ...
    'ez_httpd_send_file': function(block) {
    ...
    'ez_httpd_send_404': function(block) {
    ...
    'i2c_lcd_clear': function(block) {
      var code = 'lcd.clear()\n';

      return code;
    },

    'i2c_lcd_move_to': function(block) {
    ...
    'i2c_lcd_display': function(block) {
      var value = block.getFieldValue('value');
    ...
    'i2c_lcd_backlight': function(block) {
      var value = block.getFieldValue('value');
    ...
    'dht_temperature': function(block) {
      var code = 'dht_device.temperature()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'dht_humidity': function(block) {
      var code = 'dht_device.humidity()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'ez_ds18x20_init': function(block) {
    ...
    'ez_ds18x20_device_count': function(block) {
      var code = 'ds_device.device_count()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'ez_ds18x20_convert_temp': function(block) {
      var code =
    ...
    'ez_ds18x20_read_temp': function(block) {
    ...
    'non_block_readline': function(block) {
      var code = 'nblock.readline()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'uart_init': function(block) {
      self.imports['machine'] = 'import machine';
    ...
    'gps_update': function(block) {
      var code = 'gps_device.update()\n';

      return code;
    },

    'gps_lat': function(block) {
      var type = block.getFieldValue('type');
    ...
    'hx711_read': function(block) {
      let code = 'hx711_device.read()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'hx710_init': function(block) {
    ...
    'ez_timer_update': function(block) {
      var code = 'ez_timer_obj.update()\n';

      return code;
    },

    'ez_timer_cb': function(block) {
      // First, add a 'global' statement for every variable that is not shadowed by
      // a local parameter.
      const globals = [];
      const workspace = blockly.workspace;
    ...
    'ez_timer_set_timeout': function(block) {
      // First, add a 'global' statement for every variable that is not shadowed by
      // a local parameter.
      const globals = [];
      const workspace = blockly.workspace;
    ...
    'mfrc522_card_present': function(block) {
      var code = 'mfrc522_device.card_present()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'mfrc522_get_uid': function(block) {
      var code = 'mfrc522_device.get_uid()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'qmc5883l_init': function(block) {
    ...
    'qmc5883l_read': function(block) {
      let code = 'qmc5883l_device.read()\n';

      return code;
    },

    'qmc5883l_value': function(block) {
    ...
    'hmc5883l_read': function(block) {
      let code = 'hmc5883l_device.read()\n';

      return code;
    },

    'hmc5883l_value': function(block) {
      let axis = block.getFieldValue('axis');
    ...
    'bmp280_read': function(block) {
      let code = 'bmp280_device.read()\n';

      return code;
    },

    'bmp280_temperature': function(block) {
      let code = 'bmp280_device.get_temperature()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'bmp280_pressure': function(block) {
      let code = 'bmp280_device.get_pressure()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'bmp280_altitude': function(block) {
      let code = 'bmp280_device.get_altitude()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'max30102_init': function(block) {
    ...
    'max30102_read': function(block) {
      let code = 'max30102_device.read()\n';

      return code;
    },

    'max30102_read_succeeded': function(block) {
      let code = 'max30102_device.read_succeeded';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'max30102_read_temperature': function(block) {
      let code = 'max30102_device.read_temperature()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'max30102_beat': function(block) {
      let code = 'max30102_device.get_beat()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'max30102_bpm': function(block) {
      let code = 'max30102_device.get_bpm()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'max30102_spo2': function(block) {
      let code = 'max30102_device.get_spo2()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'max30102_value': function(block) {
    ...
    'vl53l0x_read': function(block) {
      let code = 'vl53l0x_device.read()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'vl53l1x_init': function(block) {
    ...
    'vl53l1x_read': function(block) {
      let code = 'vl53l1x_device.read()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'vl53l1x_set_distance_mode': function(block) {
    ...
    'mqtt_logger_init': function(block) {
    ...
    'mqtt_logger_log_with_time': function(block) {
      var topic = block.getFieldValue('topic');
      var value = Blockly.Python.valueToCode(block, 'value', Blockly.Python.ORDER_NONE);
    ...
    'mqtt_logger_log': function(block) {
      var topic = block.getFieldValue('topic');
      var value = Blockly.Python.valueToCode(block, 'value', Blockly.Python.ORDER_NONE);
    ...
    'ds3231_date_time_get': function(block) {
      var code = 'ds3231_device.datetime()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'ds3231_date_time_set': function(block) {
      var dateTime = Blockly.Python.valueToCode(block, 'dateTime', Blockly.Python.ORDER_NONE);
    ...
    'bme280_read': function(block) {
      let code = 'bme280_device.read()\n';

      return code;
    },

    'bme280_temperature': function(block) {
      let code = 'bme280_device.get_temperature()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'bme280_pressure': function(block) {
      let code = 'bme280_device.get_pressure()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'bme280_altitude': function(block) {
      let code = 'bme280_device.get_altitude()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'bme280_humidity': function(block) {
      let code = 'bme280_device.get_humidity()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'apds9960_init': function(block) {
    ...
    'apds9960_enable_light': function(block) {
    ...
    'apds9960_disable_light': function(block) {
      let code = 'apds9960_device.disable_light_sensor()\n';

      return code;
    },

    'apds9960_read_light': function(block) {
      let type = block.getFieldValue('type');
    ...
    'apds9960_enable_prox': function(block) {
      let gain = block.getFieldValue('gain');
      let led = block.getFieldValue('led');
    ...
    'apds9960_disable_prox': function(block) {
      let code = 'apds9960_device.disable_prox_sensor()\n';

      return code;
    },

    'apds9960_read_prox': function(block) {
      let code = 'apds9960_device.read_prox()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'apds9960_enable_gesture': function(block) {
      let gain = block.getFieldValue('gain');
      let led = block.getFieldValue('led');
    ...
    'apds9960_disable_gesture': function(block) {
      let code = 'apds9960_device.disable_gesture_sensor()\n';

      return code;
    },

    'apds9960_read_gesture': function(block) {
      let code = 'apds9960_device.read_gesture()\n';

      return code;
    },

    'apds9960_get_gesture': function(block) {
      let code = 'apds9960_device.get_gesture()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'gy33_i2c_init': function(block) {
    ...
    'gy33_i2c_read_raw': function(block) {
      let type = block.getFieldValue('type');
    ...
    'gy33_i2c_read_calibrated': function(block) {
      let type = block.getFieldValue('type');
    ...
    'gy33_i2c_set_led': function(block) {
    ...
    'gy33_i2c_calibrate_white': function(block) {
      let code = 'gy33_i2c_device.calibrate_white()\n';

      return code;
    },

    'gy33_i2c_calibrate_black': function(block) {
      let code = 'gy33_i2c_device.calibrate_black()\n';

      return code;
    },

    'gy33_uart_init': function(block) {
    ...
    'gy33_uart_update': function(block) {
      let code = 'gy33_uart_device.update()\n';

      return code;
    },

    'gy33_uart_get_raw': function(block) {
      let type = block.getFieldValue('type');
    ...
    'gy33_uart_get_calibrated': function(block) {
      let type = block.getFieldValue('type');
    ...
    'gy33_uart_set_led': function(block) {
      let power = block.getFieldValue('power');
    ...
    'gy33_uart_set_integration_time': function(block) {
    ...
    'gy33_uart_calibrate_white': function(block) {
      let code = 'gy33_uart_device.calibrate_white()\n';

      return code;
    },

    'gy33_uart_calibrate_black': function(block) {
      let code = 'gy33_uart_device.calibrate_black()\n';

      return code;
    },

    'tcs3472_init': function(block) {
    ...
    'tcs3472_read_raw': function(block) {
      let type = block.getFieldValue('type');
    ...
    'tcs3472_read_calibrated': function(block) {
      let type = block.getFieldValue('type');
    ...
    'tcs3472_set_gain': function(block) {
      let gain = block.getFieldValue('gain');
    ...
    'tcs3472_set_integration_time': function(block) {
    ...
    'tcs3472_calibrate_white': function(block) {
      let code = 'tcs3472_device.calibrate_white()\n';

      return code;
    },

    'tcs3472_calibrate_black': function(block) {
      let code = 'tcs3472_device.calibrate_black()\n';

      return code;
    },

    'tween_start': function(block) {
    ...
    'encoder_get_position': function(block) {
      let code = 'encoder_device.position()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'encoder_set_position': function(block) {
    ...
    'encoder_get_speed': function(block) {
      let code = 'encoder_device.speed()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'huskylens_init_i2c': function(block) {
    ...
    'huskylens_init_uart': function(block) {
      self.imports['huskylib'] = 'import huskylib';
      self.reservedVariables['huskylens_init'] = ['huskylens'];
    ...
    'huskylens_change_mode': function(block) {
      let mode = block.getFieldValue('mode');
    ...
    'huskylens_request': function(block) {
      let type = block.getFieldValue('type');
    ...
    'huskylens_requestByID': function(block) {
      let type = block.getFieldValue('type');
      let ID = Blockly.Python.valueToCode(block, 'ID', Blockly.Python.ORDER_NONE);
    ...
    'huskylens_results': function(block) {
      let code = 'huskylens.results';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'huskylens_idInResults': function(block) {
      let ID = Blockly.Python.valueToCode(block, 'ID', Blockly.Python.ORDER_NONE);
    ...
    'huskylens_closestBlockToCenter': function(block) {
      let type = block.getFieldValue('type');
    ...
    'huskylens_closestArrowToCenter': function(block) {
      let type = block.getFieldValue('type');
    ...
    'huskylens_forget': function(block) {
      let code =
        'huskylens.forget()\n';
    ...
    'huskylens_learn': function(block) {
      let ID = Blockly.Python.valueToCode(block, 'ID', Blockly.Python.ORDER_NONE);
    ...
    'huskylens_customText': function(block) {
    ...
    'huskylens_clearText': function(block) {
      let code =
        'huskylens.clearText()\n';
    ...
    'huskylens_saveLoadModel': function(block) {
      let type = block.getFieldValue('type');
    ...
    'huskylens_saveImage': function(block) {
      let type = block.getFieldValue('type');
    ...
    'tca9548a_get_port': function(block) {
      let code = 'tca9548a_device.get_port()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'tca9548a_set_port': function(block) {
    ...
    'music_play_tone': function(block) {
    ...
    'music_play_notes': function(block) {
    ...
    'music_play_rtttl': function(block) {
    ...
    'music_is_playing': function(block) {
      let code = 'music_device.is_playing()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'music_update': function(block) {
      let code =
        'music_device.update()\n';
    ...
    'scaled_text_init': function(block) {
    ...
    'scaled_text_text': function(block) {
    ...
    'scaled_text_text_with_background': function(block) {
      let text = Blockly.Python.valueToCode(block, 'text', Blockly.Python.ORDER_ATOMIC);
      let x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_ATOMIC);
      let y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_ATOMIC);
      let color = Blockly.Python.valueToCode(block, 'color', Blockly.Python.ORDER_ATOMIC);
    ...
    'png_decoder_render': function(block) {
    ...
    'bmp_image_close': function(block) {
      let code =
    ...
    'bmp_image_render': function(block) {
      let type = block.getFieldValue('type');
      let x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_ATOMIC);
      let y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_ATOMIC);
      let format = block.getFieldValue('format');
    ...
    'bmp_image_get_pixel': function(block) {
      let code = 'bmp_image_file.get_pixel(format=bmp_image.LIST)';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'bmp_image_width': function(block) {
      let code = 'bmp_image_file.width';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'bmp_image_height': function(block) {
      let code = 'bmp_image_file.height';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'bmp_image_depth': function(block) {
      let code = 'bmp_image_file.depth';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'hid_keyboard_init': function(block) {
    ...
    'hid_keyboard_advertising': function(block) {
      let type = block.getFieldValue('type');
    ...
    'hid_keyboard_status': function(block) {
      let type = block.getFieldValue('type');
    ...
    'hid_keyboard_send_string': function(block) {
      let value = Blockly.Python.valueToCode(block, 'value', Blockly.Python.ORDER_ATOMIC);
    ...
    'hid_keyboard_send_key': function(block) {
    ...
    'hid_mouse_advertising': function(block) {
      let type = block.getFieldValue('type');
    ...
    'hid_mouse_status': function(block) {
      let type = block.getFieldValue('type');
    ...
    'hid_mouse_send_rel': function(block) {
      let x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_ATOMIC);
      let y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_ATOMIC);
    ...
    'hid_mouse_send_abs': function(block) {
      let x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_ATOMIC);
      let y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_ATOMIC);
    ...
    'hid_mouse_send_btns': function(block) {
    ...
    'hid_ccd_advertising': function(block) {
      let type = block.getFieldValue('type');
    ...
    'hid_ccd_send_key': function(block) {
    ...
    'hid_ccd_send_key_select': function(block) {
      let key = block.getFieldValue('key');
    ...
    'hid_joystick_init': function(block) {
      self.imports['hid_services'] = 'import hid_services';
    ...
    'hid_joystick_advertising': function(block) {
      let type = block.getFieldValue('type');
    ...
    'hid_joystick_status': function(block) {
      let type = block.getFieldValue('type');
    ...
    'hid_joystick_send_axes': function(block) {
      let x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_ATOMIC);
      let y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_ATOMIC);
    ...
    'hid_joystick_send_btns': function(block) {
    ...
    'yx5300_play': function(block) {
      var code = 'yx5300_device.play()\n';

      return code;
    },

    'yx5300_play_index': function(block) {
    ...
    'yx5300_play_folder_index': function(block) {
    ...
    'yx5300_play_next': function(block) {
      var code = 'yx5300_device.play_next()\n';

      return code;
    },

    'yx5300_play_prev': function(block) {
      var code = 'yx5300_device.play_prev()\n';

      return code;
    },

    'yx5300_pause': function(block) {
      var code = 'yx5300_device.pause()\n';

      return code;
    },

    'yx5300_stop': function(block) {
      var code = 'yx5300_device.stop()\n';

      return code;
    },

    'yx5300_set_volume': function(block) {
    ...
    'ld2410_update': function(block) {
      var code = 'ld2410_device.update()\n';

      return code;
    },

    'ld2410_get_target': function(block) {
      let code = 'ld2410_device.get_target_data()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'ld2410_get_engineering': function(block) {
      let code = 'ld2410_device.get_engineering_data()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'ld2410_engineering_mode': function(block) {
      var type = block.getFieldValue('type');
    ...
    'ld2410_set_sensitivity': function(block) {
    ...
    'ld2410_factory_reset': function(block) {
      var code =
        'ld2410_device.enable_config()\n' +
    ...
    'stepper_wheels_init': function(block) {
    ...
    'stepper_wheels_enable': function(block) {
    ...
    'stepper_wheels_reset': function(block) {
      var code = 'sw_controller.reset()\n';

      return code;
    },

    'stepper_wheels_motor_run': function(block) {
    ...
    'stepper_wheels_motor_stop': function(block) {
      var index = block.getFieldValue('index');
    ...
    'stepper_wheels_motor_reset_steps': function(block) {
      var index = block.getFieldValue('index');
    ...
    'stepper_wheels_motor_get_steps': function(block) {
      var index = block.getFieldValue('index');
    ...
    'stepper_wheels_motor_set_acceleration': function(block) {
      var index = block.getFieldValue('index');
    ...
    'stepper_wheels_init_drive': function(block) {
    ...
    'stepper_wheels_drive_tank': function(block) {
    ...
    'stepper_wheels_drive_tank_steps': function(block) {
      let left = Blockly.Python.valueToCode(block, 'left', Blockly.Python.ORDER_NONE);
      let right = Blockly.Python.valueToCode(block, 'right', Blockly.Python.ORDER_NONE);
      let steps = Blockly.Python.valueToCode(block, 'steps', Blockly.Python.ORDER_NONE);
      var wait = block.getFieldValue('wait');
    ...
    'stepper_wheels_drive_steering': function(block) {
    ...
    'stepper_wheels_drive_steering_steps': function(block) {
      let steering = Blockly.Python.valueToCode(block, 'steering', Blockly.Python.ORDER_NONE);
      let speed = Blockly.Python.valueToCode(block, 'speed', Blockly.Python.ORDER_NONE);
      let steps = Blockly.Python.valueToCode(block, 'steps', Blockly.Python.ORDER_NONE);
      var wait = block.getFieldValue('wait');
    ...
    'stepper_wheels_drive_stop': function(block) {
      var code = 'sw_drive.stop()\n';

      return code;
    },

    'stepper_wheels_drive_reset_steps': function(block) {
      var code = 'sw_drive.reset_steps()\n';

      return code;
    },

    'stepper_wheels_drive_get_steps': function(block) {
      var type = block.getFieldValue('type');
    ...
    'stepper_wheels_drive_set_acceleration': function(block) {
      let acceleration = Blockly.Python.valueToCode(block, 'acceleration', Blockly.Python.ORDER_NONE);
    ...
    'stepper_wheels_init_delta': function(block) {
    ...
    'stepper_wheels_delta_move_turn': function(block) {
    ...
    'stepper_wheels_delta_move_steps': function(block) {
      let direction = Blockly.Python.valueToCode(block, 'direction', Blockly.Python.ORDER_NONE);
      let speed = Blockly.Python.valueToCode(block, 'speed', Blockly.Python.ORDER_NONE);
      let steps = Blockly.Python.valueToCode(block, 'steps', Blockly.Python.ORDER_NONE);
      var wait = block.getFieldValue('wait');
    ...
    'stepper_wheels_delta_turn_steps': function(block) {
      let turn = Blockly.Python.valueToCode(block, 'turn', Blockly.Python.ORDER_NONE);
      let steps = Blockly.Python.valueToCode(block, 'steps', Blockly.Python.ORDER_NONE);
      var wait = block.getFieldValue('wait');
    ...
    'stepper_wheels_delta_stop': function(block) {
      var code = 'sw_delta.stop()\n';

      return code;
    },

    'stepper_wheels_delta_set_acceleration': function(block) {
      let acceleration = Blockly.Python.valueToCode(block, 'acceleration', Blockly.Python.ORDER_NONE);
    ...
    'stepper_wheels_init_mecanum': function(block) {
    ...
    'stepper_wheels_mecanum_move_turn': function(block) {
      let direction = Blockly.Python.valueToCode(block, 'direction', Blockly.Python.ORDER_NONE);
      let speed = Blockly.Python.valueToCode(block, 'speed', Blockly.Python.ORDER_NONE);
      let turn = Blockly.Python.valueToCode(block, 'turn', Blockly.Python.ORDER_NONE);
    ...
    'stepper_wheels_mecanum_move_steps': function(block) {
      let direction = Blockly.Python.valueToCode(block, 'direction', Blockly.Python.ORDER_NONE);
      let speed = Blockly.Python.valueToCode(block, 'speed', Blockly.Python.ORDER_NONE);
      let steps = Blockly.Python.valueToCode(block, 'steps', Blockly.Python.ORDER_NONE);
      var wait = block.getFieldValue('wait');
    ...
    'stepper_wheels_mecanum_turn_steps': function(block) {
      let turn = Blockly.Python.valueToCode(block, 'turn', Blockly.Python.ORDER_NONE);
      let steps = Blockly.Python.valueToCode(block, 'steps', Blockly.Python.ORDER_NONE);
      var wait = block.getFieldValue('wait');
    ...
    'stepper_wheels_mecanum_stop': function(block) {
      var code = 'sw_mecanum.stop()\n';

      return code;
    },

    'stepper_wheels_mecanum_set_acceleration': function(block) {
      let acceleration = Blockly.Python.valueToCode(block, 'acceleration', Blockly.Python.ORDER_NONE);
    ...
    'camera_deinit': function(block) {
      var code = 'camera.deinit()\n';

      return code;
    },

    'camera_capture': function(block) {
      var code = 'camera.capture()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'camera_set_whitebalance': function(block) {
      var mode = block.getFieldValue('mode');
    ...
    'camera_set_saturation': function(block) {
    ...
    'camera_set_brightness': function(block) {
      var level = block.getFieldValue('level');
    ...
    'camera_set_contrast': function(block) {
      var level = block.getFieldValue('level');
    ...
    'camera_set_quality': function(block) {
    ...
    'camera2_deinit': function(block) {
      var code = 'cam2_dev.deinit()\n';

      return code;
    },

    'camera2_capture': function(block) {
      var code = 'cam2_dev.capture()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'camera2_set_whitebalance': function(block) {
      var mode = block.getFieldValue('mode');
    ...
    'camera2_set_gain': function(block) {
      var level = block.getFieldValue('level');
    ...
    'camera2_set_exposure': function(block) {
      var level = block.getFieldValue('level');
    ...
    'camera2_set_saturation': function(block) {
      var level = block.getFieldValue('level');
    ...
    'camera2_set_brightness': function(block) {
      var level = block.getFieldValue('level');
    ...
    'camera2_set_contrast': function(block) {
      var level = block.getFieldValue('level');
    ...
    'camera2_set_quality': function(block) {
      var quality = block.getFieldValue('quality');
    ...
    'mv_find_blobs_yuv': function(block) {
    ...
    'mv_find_blobs_grayscale': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'mv_find_circle_single': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'mv_yuv_to_grayscale': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'mv_gaussian_blur_3x3_gray': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'mv_gaussian_blur_3x3_yuv': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'mv_scale_grayscale': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'mv_crop_grayscale': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'mv_crop_row_grayscale': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'mv_crop_row_yuv': function(block) {
      self.imports['mv'] = 'import mv';
    ...
    'wheeled_drives_steering': function(block) {
    ...
    'wheeled_drives_joystick': function(block) {
      self.imports['wheeled_drives'] = 'import wheeled_drives';
    ...
    'wheeled_drives_delta': function(block) {
      self.imports['wheeled_drives'] = 'import wheeled_drives';
    ...
    'wheeled_drives_mecanum': function(block) {
      self.imports['wheeled_drives'] = 'import wheeled_drives';
    ...
    'ili9341_text8x8': function(block) {
      self.imports['ili9341'] = 'import ili9341';
    ...
    'ili9341_text_with_font': function(block) {
      self.imports['ili9341'] = 'import ili9341';
    ...
    'ili9341_rectangle': function(block) {
      self.imports['ili9341'] = 'import ili9341';
    ...
    'ili9341_ellipse': function(block) {
      self.imports['ili9341'] = 'import ili9341';
    ...
    'ili9341_image_from_file': function(block) {
      self.imports['ili9341'] = 'import ili9341';
    ...
    'ili9341_image_from_buf': function(block) {
      self.imports['ili9341'] = 'import ili9341';
    ...
    'xglcd_font_load': function(block) {
    ...
    'xpt2046_init_no_int': function(block) {
      self.imports['xpt2046'] = 'import xpt2046';
      self.reservedVariables['xpt2046_init'] = ['xpt2046_device'];
    ...
    'xpt2046_get_touch': function(block) {
      self.imports['xpt2046'] = 'import xpt2046';
    ...
    'xpt2046_get_pos': function(block) {
      self.imports['xpt2046'] = 'import xpt2046';
    ...
    'xpt2046_in_rect': function(block) {
      self.imports['xpt2046'] = 'import xpt2046';
    ...
    'xpt2046_in_circle': function(block) {
      self.imports['xpt2046'] = 'import xpt2046';
    ...
    'st7789_text_with_font': function(block) {
      self.imports['st7789'] = 'import st7789';
    ...
    'st7789_rectangle': function(block) {
      self.imports['st7789'] = 'import st7789';
    ...
    'st7789_image_from_file': function(block) {
      self.imports['st7789'] = 'import st7789';
    ...
    'st7789_image_from_buf': function(block) {
      self.imports['st7789'] = 'import st7789';
    ...
    'lds02rr_update': function(block) {
      var code = 'lds02rr_device.update()\n';

      return code;
    },

    'lds02rr_rpm': function(block) {
      let code = 'lds02rr_device.get_rpm()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'lds02rr_distances': function(block) {
      let code = 'lds02rr_device.get_distances()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'amg8833_init': function(block) {
    ...
    'amg8833_set_ma_mode': function(block) {
      let mode = block.getFieldValue('mode');
    ...
    'amg8833_get_buf': function(block) {
      let format = block.getFieldValue('format');
    ...
    'amg8833_get_temperature': function(block) {
      let x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_NONE);
      let y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_NONE);
    ...
    'amg8833_get_thermistor_temperature': function(block) {
      let code =
    ...
    'vs1003_set_stream_mode': function(block) {
      let mode = block.getFieldValue('mode');
    ...
    'vs1003_set_volume': function(block) {
    ...
    'vs1003_dreq_ready': function(block) {
      let code =
    ...
    'vs1003_play_bytes': function(block) {
    ...
    'vs1003_play_file': function(block) {
      let filename = Blockly.Python.valueToCode(block, 'filename', Blockly.Python.ORDER_NONE);
    ...
    'vs1003_reset': function(block) {
      let code = 'vs1003_device.reset()\n';

      return code;
    },

    'vs1003_start_recording_to_file': function(block) {
      let filename = Blockly.Python.valueToCode(block, 'filename', Blockly.Python.ORDER_NONE);
    ...
    'vs1003_record_to_file': function(block) {
      let code = 'vs1003_device.record_to_file()\n';

      return code;
    },

    'vs1003_stop_recording_to_file': function(block) {
      let code = 'vs1003_device.stop_recording_to_file()\n';

      return code;
    },

    'bytesBuffer_init': function(block) {
    ...
    'coind4_start': function(block) {
      let code = 'coind4_device.start()\n';

      return code;
    },

    'coind4_stop': function(block) {
      let code = 'coind4_device.stop()\n';

      return code;
    },

    'coind4_update': function(block) {
      let code = 'coind4_device.update()\n';

      return code;
    },

    'coind4_update_return': function(block) {
      let code = 'coind4_device.update()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'coind4_rpm': function(block) {
      let code = 'coind4_device.get_rpm()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'coind4_measurements': function(block) {
      let code = 'coind4_device.get_measurements()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'delta2d_init': function(block) {
    ...
    'delta2d_update': function(block) {
      let code = 'delta2d_device.update()\n';

      return code;
    },

    'delta2d_update_return': function(block) {
      let code = 'delta2d_device.update()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'delta2d_rpm': function(block) {
      let code = 'delta2d_device.get_rpm()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'delta2d_measurements': function(block) {
      let code = 'delta2d_device.get_measurements()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'pms7003_init': function(block) {
    ...
    'pms7003_update': function(block) {
      let code = 'pms7003_device.update()\n';

      return code;
    },

    'pms7003_update_return': function(block) {
      let code = 'pms7003_device.update()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'pms7003_measurements': function(block) {
      let code = 'pms7003_device.get_measurements()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'pms7003_set_mode': function(block) {
      let mode = block.getFieldValue('mode');
    ...
    'pms7003_sleep': function(block) {
      let code = 'pms7003_device.sleep()\n';

      return code;
    },

    'pms7003_wake': function(block) {
      let code = 'pms7003_device.wake()\n';

      return code;
    },

    'pms7003_read': function(block) {
      let code = 'pms7003_device.read()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'ags10_init': function(block) {
    ...
    'ags10_read': function(block) {
      let code = 'ags10_device.read()';

      return [code, Blockly.Python.ORDER_ATOMIC];
    },

    'ags10_set_zero': function(block) {
      let type = block.getFieldValue('type');
    ...
    'mlx90640_get_buf': function(block) {
      let code =
    ...
    'mlx90640_get_temperature': function(block) {
      let x = Blockly.Python.valueToCode(block, 'x', Blockly.Python.ORDER_NONE);
      let y = Blockly.Python.valueToCode(block, 'y', Blockly.Python.ORDER_NONE);
